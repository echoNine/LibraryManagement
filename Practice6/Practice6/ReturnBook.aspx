<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReturnBook.aspx.cs" Inherits="Practice6.ReturnBook" %>
...
<body>
    <form id="form2" runat="server">
       ...
       <asp:Menu ID="Menu1" runat="server" Orientation="Horizontal" Font-Size="16px" ForeColor="White" Height="50px" Width="800px" style="line-height:50px; position:absolute; top:0;left:20%; text-align:center">
        ...
        <div class="Info">
            <span class="title">图书归还</span><hr />
            <div class="readerInfo" style="font-size: 15px; padding: 0px 10%;">
                读者编号：<asp:TextBox ID="readerBarCode" runat="server" Height="22px"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="findreader" runat="server" Text="查找读者" OnClick="btnReaderSearch_Click" /><br />
            ...
            <div class="bookInfo" style="font-size: 15px;padding: 0px 10%;"">
                ...
                <asp:GridView ID="gvBookReturn" runat="server" AutoGenerateColumns="False" DataKeyNames="bookBarCode" OnSelectedIndexChanging="gvBookReturn_SelectedIndexChanging" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black" GridLines="None" Width="814px" style="margin-top:10px;">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="hire" HeaderText="租金/期" />

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookBorrowSearch.aspx.cs" Inherits="Practice6.BookBorrowSearch" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="Main">
            <span class="title">图书借阅查询</span><hr />
            <div class="item">
                选择查询条件：
                <asp:DropDownList ID="searchItem" runat="server" AutoPostBack="True">
                    ...
                    <asp:ListItem Value="readerBarCode">读者编号</asp:ListItem>
                    <asp:ListItem Value="readerName">读者姓名</asp:ListItem>
                </asp:DropDownList>
                <asp:TextBox ID="target" runat="server"></asp:TextBox>
                <asp:Button ID="btnSearch" runat="server" OnClick="btnSearch_Click" Text="查询" /><br />
                <asp:GridView ID="gvBorrowInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False" Width="720px" DataKeyNames="bookBarCode" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center">
                    <FooterStyle BackColor="White" ForeColor="#000066" />
                    <Columns>
                        <asp:BoundField DataField="bookBarCode" HeaderText="图书条形码" />
                        <asp:BoundField DataField="bookName" HeaderText="图书名称" />
                        <asp:BoundField DataField="readerBarCode" HeaderText="读者编号" />
